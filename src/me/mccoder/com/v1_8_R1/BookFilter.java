package me.mccoder.com.v1_8_R1;
  ...
  implements IBookFilter
{
  ...
  private Set<EnumClickAction> filterActions = EnumSet.of(EnumClickAction.RUN_COMMAND, EnumClickAction.OPEN_FILE, EnumClickAction.OPEN_URL, EnumClickAction.SUGGEST_COMMAND);
  ...
  public org.bukkit.inventory.ItemStack filterBook(org.bukkit.inventory.ItemStack filterItem)
  {
    ...
    if (result != null) {
      return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_8_R1.ItemStack)result);
    }
    return null;
  }
  ...
  public Object filterBook(Object filterItem)
  {
    ...
    if (!(filterItem instanceof net.minecraft.server.v1_8_R1.ItemStack)) {
      throw new IllegalArgumentException("Expected object of type net.minecraft.server.v1_8_R1.ItemStack. Received " + filterItem.getClass());
    }
    net.minecraft.server.v1_8_R1.ItemStack mcStack = (net.minecraft.server.v1_8_R1.ItemStack)filterItem;
    try
    {
      ...
      for (int i = 0; (pages != null) && (i < pages.size()); i++)
      {
        ...
        try
        {
          component = jsonPage != null ? ChatSerializer.a(jsonPage) : null;
        }
        catch (Exception e)
        {
          component = null;
        ...
        for (IChatBaseComponent subComponent : subComponents)
        {
          ...
          if ((clickable != null) && (this.filterActions.contains(clickable.a())))
          {
            ...
            modifier.setChatHoverable(new ChatHoverable(EnumHoverAction.SHOW_TEXT, new ChatComponentText(this.hoverMsg)));
        ...
        if (changedPage)
        {
          jsonPage = ChatSerializer.a(component);
  ...
  {
    this.filterActions = EnumSet.noneOf(EnumClickAction.class);
    for (String actionString : actions) {
      try
      {
        this.filterActions.add(EnumClickAction.valueOf(actionString.toUpperCase()));
      }
