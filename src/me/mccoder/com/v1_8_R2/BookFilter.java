package me.mccoder.com.v1_8_R2;
  ...
  implements IBookFilter
{
  ...
  public org.bukkit.inventory.ItemStack filterBook(org.bukkit.inventory.ItemStack filterItem)
  {
    ...
    if (result != null) {
      return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_8_R2.ItemStack)result);
    }
    return null;
  }
  ...
  public Object filterBook(Object filterItem)
  {
    ...
    if (!(filterItem instanceof net.minecraft.server.v1_8_R2.ItemStack)) {
      throw new IllegalArgumentException("Expected object of type net.minecraft.server.v1_8_R2.ItemStack. Received " + filterItem.getClass());
    }
    net.minecraft.server.v1_8_R2.ItemStack mcStack = (net.minecraft.server.v1_8_R2.ItemStack)filterItem;
    try
    {
